...
var AMsqrt = {input:"sqrt", tag:"msqrt", output:"sqrt", tex:null, ttype:UNARY},
  ...
  AMqvar  = {input:"?",    tag:"qvar",  output:"?", tex:null, ttype:UNARY};
...
AMsqrt, AMroot, AMfrac, AMdiv, AMover, AMsub, AMsup, AMqvar,
...
function AMparseSexpr(str) { //parses str and returns [node,tailstr]
  ...
  case UNARY:
      ...
      if (symbol.input == "sqrt") {           // sqrt
        ...
        node = AMcreateMmlNode(symbol.tag, AMcreateMmlNode("mtext", document.createTextNode("?")));
        console.log(node);
        console.log(result[0]);
        node.appendChild(result[0]);
        node.setAttribute("name", result[0].textContent);
        return [node,result[1]];
...
var LMsqrt = {input:"\\sqrt",	tag:"msqrt", output:"sqrt",	ttype:UNARY},
  ...
  LMqvar = {input:"\\qvar", tag:"qvar", output:"?", ttype:UNARY};
...
//commands with argument
LMsqrt, LMroot, LMfrac, LMover, LMsub, LMsup, LMtext, LMmbox, LMatop, LMchoose, LMqvar,
//LMdiv, LMquote,
